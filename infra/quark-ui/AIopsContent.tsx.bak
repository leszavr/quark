                  ...
                  <HStack justify="space-between" align="start">
                    <HStack align="start" spacing={4} flex={1}>
                      <Box
                        p={2}
                        borderRadius="lg"
                        bg={useColorModeValue(`${getTypeColor(proposal.type)}.50`, `${getTypeColor(proposal.type)}.900`)}
          ...
          <ModalHeader>
            <HStack>
              ...
              <VStack align="start" spacing={0}>
                ...
                <HStack>
                  <Badge colorScheme={getTypeColor(selectedProposal?.type)} variant="subtle">
                  ...
                  <Badge colorScheme={getImpactColor(selectedProposal?.impact)} variant="outline">
                    {selectedProposal?.impact === 'high' ? 'Высокий' :
                     selectedProposal?.impact === 'medium' ? 'Средний' : 'Низкий'} приоритет
                  </Badge>
                </HStack>
              </VStack>
            </HStack>
              ...
              <VStack align="stretch" spacing={6}>
                ...
                <Grid templateColumns={{ base: "1fr", md: "repeat(3, 1fr)" }} gap={4}>
                  <Box>
                    ...
                    <HStack>
                      <Progress 
                        value={selectedProposal.confidence} 
                        colorScheme={selectedProposal.confidence > 80 ? 'green' : 'yellow'}
                        size="lg"
                        flex={1}
                      />
                      <Text fontWeight="bold">{selectedProposal.confidence}%</Text>
                    </HStack>
                  </Box>
                  <Box>
