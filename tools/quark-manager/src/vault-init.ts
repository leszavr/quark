 ...
 */
async function checkVaultHealth(config: VaultConfig): Promise<boolean> {
 ...
 */
async function enableKVEngine(config: VaultConfig): Promise<void> {
 ...
 */
async function createSecrets(config: VaultConfig): Promise<{
  dbPassword: string;
  jwtSecret: string;
 ...
 */
async function createPolicies(config: VaultConfig): Promise<void> {
...
async function exportToEnvFile(
  projectRoot: string,
  config: VaultConfig,
  secrets: { dbPassword: string; jwtSecret: string; minioPassword: string }
): Promise<void> {
 ...
 */
async function createAppRole(config: VaultConfig, projectRoot: string): Promise<void> {
 ...
 */
function displayStatus(config: VaultConfig): void {
